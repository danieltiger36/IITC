...
function addCategory(product, category) {
  product.categories.push = "mobile";
}
...
//   for (let i = 0; i < productNameroducts.length; i++){
//     for (let j = 0; j < products[i].length; j++){
//        if products[i][j] = true {
//        return myProducts;
//        } else return false;
//     }
...
//     for (let j = 0; j <products[i]; j++){
//         if products[i][j] = category {
//             count += products[i][j];
//         }
//         console.log(c_count);
//     }
...
// let avragePrice = 0;
// for (let i = 0; i < products.length; i++){
//     for (let j = 0; j <products.length.addCategory[i]; j++)
//         avragePrice += products.price[i][j];
